...
*/
 ...
 public:
  ...
  void
  forward_event (tw_bf *bf, nemo_message *m, tw_lp *lp);

  void
  reverse_event (tw_bf *bf, nemo_message *m, tw_lp *lp);

  void
  core_commit (tw_bf *bf, nemo_message *m, tw_lp *lp);

  void
  pre_run (tw_lp *lp);

  void
  core_finish (tw_lp *lp);
