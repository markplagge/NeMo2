...
namespace nemo {
	namespace p {
		...
		void start_sim_hdr() {
			...
			//134 too?
			nemo_name << bold_on << print_as_color<ColorCode::x_red_196>(" NeMo ") << bold_on <<
					print_as_color<ColorCode::bright_green>(" 2") << bold_off << print_as_color<ColorCode::bright_blue>(" -")
					        << print_as_color<ColorCode::green>(" The Next Generation ");
